...
from pychatbot.search import TextSearch, IndexedTextSearch
...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'pychatbot.storage.SQLStorageAdapter')

        logic_adapters = kwargs.get('logic_adapters', [
            'pychatbot.logic.BestMatch'
        ])
        ...
        preprocessors = kwargs.get(
            'preprocessors', [
                'pychatbot.preprocessors.clean_whitespace'
            ]
        )
