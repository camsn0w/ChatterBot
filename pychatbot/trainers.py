...
from pychatbot.tagging import PosLemmaTagger
...
class Trainer(object):
    ...
    :param boolean show_training_progress: Show progress indicators for the
           trainer. The environment variable ``pychatbot_SHOW_TRAINING_PROGRESS``
    ...
    def __init__(self, chatbot, **kwargs):
        ...
        environment_default = os.getenv('pychatbot_SHOW_TRAINING_PROGRESS', True)
    ...
    class TrainerInitializationException(Exception):
        ...
        def __init__(self, message=None):
            default = (
                ...
                'See http://pychatbot.readthedocs.io/en/stable/training.html'
            )
...
class pychatbotCorpusTrainer(Trainer):
    """
    Allows the chat bot to be trained using data from the
    pychatbot dialog corpus.
    """

    def train(self, *corpus_paths):
        from pychatbot.corpus import load_corpus, list_corpus_files
