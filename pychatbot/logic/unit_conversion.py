...
from pychatbot.exceptions import OptionalDependencyImportError
from pychatbot import languages
from pychatbot import parsing
...
class UnitConversion(LogicAdapter):
    ...
    :kwargs:
        * *language* (``object``) --
        The language is set to ``pychatbot.languages.ENG`` for English by default.
    """
